    ...
    <section className="bg-white py-20 dark:bg-[#080b14] dark:text-white  dark:border-slate-800">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-900 mb-4 dark:text-slate-100  ">Why Choose AIO Chat ?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2 dark:text-slate-100">Secure & Private</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2 dark:text-slate-100">User-Friendly</h3>
